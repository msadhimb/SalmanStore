      ...
      <div class="row">
        <div class="container">
          ...
          <div class="row justify-content-evenly text-center mt-3 mb-5">
            <div class="col-lg-4">
              <p class="pKiri">Salman Store's berdiri sejak 1001, kami menyediakan layanan untuk menjual headset terpilih dari berbagai merek. <br> Website yang kami buat memiliki fitur sederhana yang mudah untuk dipakai disemua kalangan masyarakat. Harga yang kami berikan juga selalu yang terbaik dan termurah di kalangannya. <br> Segera belanja di toko kami sekarang juga. </p>
            </div>
            <div class="col-lg-5">
